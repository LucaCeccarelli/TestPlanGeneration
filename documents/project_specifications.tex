...
\begin{ganttchart}[
  ...
  bar label node/.style={text width=4.0cm, align=right, font=\footnotesize},
  group/.style={fill=primary!80, draw=primary},
  group label font=\footnotesize\bfseries,
  milestone/.style={fill=orange!90, draw=orange!70!black, rounded corners=2pt},
  milestone label node/.style={text width=4.0cm, align=right, font=\footnotesize\itshape},
  ...
  \gantttitle{Phase 3 — Éval. \& Rédaction}{2} \\

  \gantttitle[title label font=\scriptsize\color{gray}]{Mar}{1}
  \gantttitle[title label font=\scriptsize\color{gray}]{Avr}{1}
  \gantttitle[title label font=\scriptsize\color{gray}]{Mai}{1}
  \gantttitle[title label font=\scriptsize\color{gray}]{Juin}{1}
  \gantttitle[title label font=\scriptsize\color{gray}]{Sep}{1}
  \gantttitle[title label font=\scriptsize\color{gray}]{Oct}{1}
  \gantttitle[title label font=\scriptsize\color{gray}]{Nov}{1}
  \gantttitle[title label font=\scriptsize\color{gray}]{Déc}{1}
  \gantttitle[title label font=\scriptsize\color{gray}]{Jan}{1}
  \gantttitle[title label font=\scriptsize\color{gray}]{Fév}{1}
  \gantttitle[title label font=\scriptsize\color{gray}]{Mars}{1} \\
...
\textcolor{orange}{\rule{0.7cm}{4pt}\hspace{1pt}}~Jalon \quad}}
