...
\begin{tabularx}{\linewidth}{|>{\raggedright\arraybackslash}X|C{1.6cm}|C{1.9cm}|C{1.9cm}|C{1.6cm}|}
  ...
  \hline
  Conception de la méthode (axes A, B, C)        & R, A & C & C & I \\
  \hline
  Implémentation Axe A (extraction NLP)          & R, A & C & C & I \\
  \hline
  Implémentation Axe B (multi-agents)            & R, A & C & C & I \\
  \hline
  Implémentation Axe C (validation, optionnel)   & R, A & C & C & I \\
  \hline
...
% Colonnes : 1=Mar  2=Avr  3=Mai  4=Juin  5=Sep  6=Oct  7=Nov  8=Déc
%            9=Jan  10=Fév  11=Mars·27   (Juil–Août non représentés)
\begin{landscape}
\thispagestyle{empty}
...
\begin{ganttchart}[
  ...
  y unit title=0.60cm,
  y unit chart=0.60cm,
  canvas/.style={fill=white, draw=gray!25},
  title/.style={fill=primary!18, draw=primary!50},
  title label font=\footnotesize\bfseries\color{primary},
  title height=1,
  bar height=0.50,
  bar top shift=0.25,
  bar label node/.style={text width=3.8cm, align=right, font=\footnotesize},
  group/.style={fill=primary!70, draw=primary},
  group label node/.style={text width=3.8cm, align=right, font=\footnotesize\bfseries},
  group peaks height=0.20,
  milestone/.style={fill=orange!85, draw=orange!60!black},
  milestone label node/.style={text width=3.8cm, align=right, font=\footnotesize\itshape},
  link/.style={-latex, draw=gray!50}
]{1}{11}

  %% ── Ligne 1 : phases
  \gantttitle{Phase 1 — Exploration}{4}
  \gantttitle{Phase 2 — Prototype}{4}
  \gantttitle{Ph.3 — Éval./Réd.}{3} \\

  %% ── Ligne 2 : mois
  \gantttitle[title/.style={fill=white,draw=gray!40},
    title label font=\scriptsize\color{gray!80}]{Mar}{1}
  \gantttitle[title/.style={fill=white,draw=gray!40},
    title label font=\scriptsize\color{gray!80}]{Avr}{1}
  \gantttitle[title/.style={fill=white,draw=gray!40},
    title label font=\scriptsize\color{gray!80}]{Mai}{1}
  \gantttitle[title/.style={fill=white,draw=gray!40},
    title label font=\scriptsize\color{gray!80}]{Juin}{1}
  \gantttitle[title/.style={fill=white,draw=gray!40},
    title label font=\scriptsize\color{gray!80}]{Sep}{1}
  \gantttitle[title/.style={fill=white,draw=gray!40},
    title label font=\scriptsize\color{gray!80}]{Oct}{1}
  \gantttitle[title/.style={fill=white,draw=gray!40},
    title label font=\scriptsize\color{gray!80}]{Nov}{1}
  \gantttitle[title/.style={fill=white,draw=gray!40},
    title label font=\scriptsize\color{gray!80}]{Déc}{1}
  \gantttitle[title/.style={fill=white,draw=gray!40},
    title label font=\scriptsize\color{gray!80}]{Jan}{1}
  \gantttitle[title/.style={fill=white,draw=gray!40},
    title label font=\scriptsize\color{gray!80}]{Fév}{1}
  \gantttitle[title/.style={fill=white,draw=gray!40},
    title label font=\scriptsize\color{gray!80}]{Mars}{1} \\

  %% ── PHASE 1
  \ganttgroup[group/.style={fill=axeA!65,draw=axeA}]{Phase 1}{1}{4} \\
  \ganttbar[bar/.style={fill=axeA!45,draw=axeA,rounded corners=1pt}]
    {J1}{1}{4} \\
  \ganttbar[bar/.style={fill=axeA!45,draw=axeA,rounded corners=1pt}]
    {J2}{4}{4} \\
  ...
  %% ── PHASE 2
  \ganttgroup[group/.style={fill=axeB!65,draw=axeB}]{Phase 2}{5}{8} \\
  \ganttbar[bar/.style={fill=axeB!45,draw=axeB,rounded corners=1pt}]
    {J3}{5}{5} \\
  \ganttbar[bar/.style={fill=axeB!45,draw=axeB,rounded corners=1pt}]
    {J4}{6}{6} \\
  \ganttbar[bar/.style={fill=axeB!45,draw=axeB,rounded corners=1pt}]
  ...
  %% ── PHASE 3
  \ganttgroup[group/.style={fill=axeC!65,draw=axeC}]{Phase 3}{9}{11} \\
  \ganttbar[bar/.style={fill=axeC!40,draw=axeC,rounded corners=1pt}]
    {J8}{9}{9} \\
  \ganttbar[bar/.style={fill=axeC!40,draw=axeC,rounded corners=1pt}]
    {J9}{9}{10} \\
  \ganttbar[bar/.style={fill=axeC!40,draw=axeC,rounded corners=1pt}]
...
\textcolor{axeA}{\rule{0.7cm}{4pt}}~Phase 1 / Axe A \quad
\textcolor{axeB}{\rule{0.7cm}{4pt}}~Phase 2 / Axe B \quad
\textcolor{axeC}{\rule{0.7cm}{4pt}}~Phase 3 / Axe C \quad
\textcolor{orange}{\rule{0.5cm}{4pt}}~Jalon \quad
